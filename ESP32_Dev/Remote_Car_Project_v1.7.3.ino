...
const char* ssid = "Luc2007";
const char* password = "KaNaTa-2022";
    ...
    <body>
      ...
      <nav class="main-nav">
        <ul class="navbar-nav">
          ...
          <li><a class="active">Remote Car Control</a></li>
          <li><a href="#" id="sensorLink">Sensors</a></li>
...
void setupCamera()
{
  ...
  // config.flip_vertical = true;  not support, added by Lucina Nov 21,2024
  ...
  // camera picutre flipping handing - added by Lucina Nov 21,2024 
  sensor_t *s = esp_camera_sensor_get();
  if (s != NULL) {
      s->set_vflip(s, 1);           // Vertical flip：1=enable； 0=disable
